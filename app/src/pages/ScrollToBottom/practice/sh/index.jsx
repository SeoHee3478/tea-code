...
const ScrollToBottom = () => {
  ...
  const handleChatList = (chat) => {
    setChatList((state) => [...state, chat]);
  }

  return (
    <div style={{ display: "flex", gap: "30px" }}>
      <ChatRoom title={'민경'} chatList={chatList} handleChatList={handleChatList} />
      <ChatRoom title={'서희'} chatList={chatList} handleChatList={handleChatList} />
    </div>
  );
};
